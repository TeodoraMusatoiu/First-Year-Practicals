...
> drawMaze :: Maze -> IO()
> drawMaze maze = do
>	 putStr("Isn't that a-maze-ing!\n")
> 	 putStr(drawSouth (0, snd(sizeOf maze)) maze)

> drawSouth :: Place -> Maze -> String
> drawSouth (x,y) maze 
> 	| y < 0		 		= ""
> 	| x > fst(sizeOf maze)  	= "\n" ++ drawWest (0, y-1) maze
> 	| hasWall maze (x,y) S == True  = "+--" ++ drawSouth (move E (x,y)) maze
> 	| hasWall maze (x,y) S == False = "+  " ++ drawSouth (move E (x,y)) maze

> drawWest :: Place -> Maze -> String
> drawWest (x,y) maze
> 	| y < 0				= ""
> 	| x > fst(sizeOf maze)          = "\n" ++ drawSouth (0, y) maze
> 	| hasWall maze (x,y) W == True  = "|  " ++ drawWest (move E (x,y)) maze
> 	| hasWall maze (x,y) W == False = "   " ++ drawWest (move E (x,y)) maze
...
> solveMazeIter maze (x,y) ((place,path):places) 
> 		| place == (x,y) = path
> 		
